package com.vaadin.addressbook;
...
public class AddressbookUI extends UI {
	...
	private void initLayout() {
		...
		Label AppTitle = new Label("Welcome to Kaizen v0.014.1");
		
		MainVLayout.addComponent(AppTitle);
			 
		/* Build the component tree */
		HorizontalSplitPanel splitPanel = new HorizontalSplitPanel();
		MainVLayout.addComponent(splitPanel);
		...
		//add components to bottomleft layout
		bottomLeftLayout.addComponent(searchField);
		bottomLeftLayout.addComponent(addNewContactButton);
		
		//place the bottomleft layout before the list
